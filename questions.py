def random_questions(message):
    if message == "how old are you?"
        return "I dont have age"
    elif message == "who made you" or "who is your creator?" or "who invented you?" or "who is your ceo?"
        return "Students From Coventry Univeristy created me"
    elif message == "what are you ?" or "who are you?"
